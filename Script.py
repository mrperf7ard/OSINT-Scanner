...
with open('output/vulnscan_pro.py', 'w', encoding='utf-8') as f:
    f.write(tool)

# Verify syntax
import py_compile
try:
    py_compile.compile('output/vulnscan_pro.py', doraise=True)
    print("✓ Syntax OK")
except py_compile.PyCompileError as e:
    print(f"✗ Syntax error: {e}")

import os
size = os.path.getsize('output/vulnscan_pro.py')
